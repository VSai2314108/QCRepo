...
class UncorelatedBonds(AlphaQM):
    def __init__(self, customAlgo: QCAlgorithm) -> None:
        symbols = [
            "SPY", "IEF", "BIL", "SVXY", "UUP", "TQQQ", "TECL", "UPRO", "SQQQ", "SOXS", "TECS", "UVXY", "TLT", "BND", "PSQ", "QQQ", "VIXY", "SHY", "GLD", "XLP", "BTAL", "SHV", "TMF", "VIXM", "SOXL"
        ]
        indicators = [
            ...
            (MaxDrawdownQM, 10), (VolatilityQM, 5), (VolatilityQM, 10), (VolatilityQM, 45), (CumulativeReturnQM, 100),
    ...
    def calculate(self):
        ...
        self.ief_ma200 = self.customAlgo.indicators["IEF"]["MovingAverageQM_200"].temp_value
        self.ief_ma450 = self.customAlgo.indicators["IEF"]["MovingAverageQM_450"].temp_value
        self.svxy_mdd2 = self.customAlgo.indicators["SVXY"]["MaxDrawdownQM_2"].temp_value
        self.svxy_mdd3 = self.customAlgo.indicators["SVXY"]["MaxDrawdownQM_3"].temp_value
        ...
        self.qqq_vol10 = self.customAlgo.indicators["QQQ"]["VolatilityQM_10"].temp_value
        self.spy_vol5 = self.customAlgo.indicators["SPY"]["VolatilityQM_5"].temp_value
        self.qqq_mdd10 = self.customAlgo.indicators["QQQ"]["MaxDrawdownQM_10"].temp_value
        self.tlt_mdd10 = self.customAlgo.indicators["TLT"]["MaxDrawdownQM_10"].temp_value
        self.tmf_mdd10 = self.customAlgo.indicators["TMF"]["MaxDrawdownQM_10"].temp_value
        ...
        self.vixy_vol40 = self.customAlgo.indicators["VIXY"]["VolatilityQM_40"].temp_value
        ...
        self.svxy_vol2 = self.customAlgo.indicators["SVXY"]["VolatilityQM_2"].temp_value
        self.svxy_vol3 = self.customAlgo.indicators["SVXY"]["VolatilityQM_3"].temp_value
        self.spy_vol21 = self.customAlgo.indicators["SPY"]["VolatilityQM_21"].temp_value
        self.spy_rsi5 = self.customAlgo.indicators["SPY"]["RelativeStrengthIndexQM_5"].temp_value
        self.spy_vol10 = self.customAlgo.indicators["SPY"]["VolatilityQM_10"].temp_value
        ...
        if current_month in [11, 12]:
            ...
            if self.ief_ma200 > self.ief_ma450:
    ...
    def inverse_volatility_weighted(self, tickers, window):
    ...
    def get_nbdb_allocation(self):
        if self.tlt_mdd10 > 10.0:
            return [("SHV", 1)]
        else:
            return self.inverse_volatility_weighted(["SHV", "TQQQ"], 45)
            ...
            if self.tqqq_cr6 < -12.0:
                if self.tqqq_cr1 > 5.5:
                    ...
                    if self.tqqq_rsi10 < 32.0:
                        ...
                        if self.tmf_mdd10 < 7.0:
                            return [("TQQQ", 1)]
                        else:
                            return [("SHV", 1)]
            else:
                if self.qqq_mdd10 > 10.0:
                    return [("SHV", 1)]
                else:
                    if self.tmf_mdd10 > 10.0:
                        return [("SHV", 1)]
                    else:
    ...
    def get_babII_allocation(self):
        if self.svxy_vol2 > 10.0:
            return [("SHV", 1)]
        else:
            if self.svxy_vol3 > 20.0:
                return [("SHV", 1)]
            else:
                if self.qqq_rsi10 > 80:
                    return [("UVXY", 0.5), ("BTAL", 0.5)]
                else:
                    if self.spy_vol21 < 1.25:
                        if self.bnd_cr60 > self.bil_cr60:
                            return [("TQQQ", 1)]
                        else:
                            return [("SVXY", 0.55), ("BTAL", 0.45)]
